      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <a href="{{ route('admin.city-import-page') }}" class="btn btn-success"><i class="fas fa-plus"></i> {{__('Bulk Upload')}}</a>
                            ...
                            <tbody>
                                @foreach ($cities as $index => $city)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td>{{ $city->name }}</td>
                                        <td>{{ $city->countryState->name ?? 'None' }}</td>
                                        <td>{{ $city->countryState->country->name ?? 'None' }}</td>
                                        <td>
                                            @if($city->status == 1)
